...
class PrFirebaseAuthExceptions implements Exception {
  /// The error code associated with the exception.
  final String code;
// Constructor that takes an error code.
  PrFirebaseAuthExceptions(this.code);
  ...
  String get message {
    switch (code) {
      ...
      default:
        return 'An unexcepted Authentication error occured. Please try again';
    }
  }
}
